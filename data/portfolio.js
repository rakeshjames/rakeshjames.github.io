...
export const siteConfig = {
  ...
  availability: {
    ...
    detail: 'Remote-first · UK & international · Immediate start',
  },
}
...
export const employmentSummary = [
  ...
  {
    sector: 'Global Digital Agency — EMEA',
    role: 'Drupal Lead Architect',
    period: 'Apr 2021 – Nov 2021',
    tenure: '8 months',
    domains: ['Agency', 'Multi-Market CMS'],
    summary: 'Led EMEA CMS practice and acted as digital solution lead within an Omnicom-group agency. Defined and governed architecture for complex multi-market Drupal implementations. Owned client technical relationships and presales solutioning.',
    highlights: [
      'Led multi-market Drupal architecture across 6 simultaneous client engagements',
      'Established EMEA solution practice standards adopted across the delivery team',
    ],
  },
  {
    sector: 'Enterprise SaaS Platform',
    role: 'Senior Architect & Platform Lead',
    period: 'Aug 2018 – Mar 2021',
    tenure: '2.5 years',
    domains: ['SaaS', 'Payments', 'React', 'Flutter'],
    summary: 'Architect and platform lead across product engineering squads. Owned API evolution strategy, third-party payment integration, and introduced modern front-end (React, Flutter) to a Drupal-backed platform product. Championed open-source contribution culture as a company-wide initiative.',
    highlights: [
      'Designed and shipped Stripe API v2→v3 migration across customer-facing payments',
      'Introduced React and Flutter as platform front-end standards',
      'Led internal open-source contribution programme adopted across engineering',
    ],
  },
  {
    sector: 'API & Developer Portal Consultancy',
    role: 'Senior Developer Portal Architect',
    period: 'Oct 2018 – Jul 2019',
    tenure: '10 months',
    domains: ['Apigee', 'Developer Experience', 'API'],
    summary: 'Specialist architect for Drupal + Apigee developer-portal implementations. Delivered self-service API onboarding experiences and trained client engineering teams on developer-experience best practices.',
    highlights: [
      'Delivered 3 Apigee developer portals on Drupal with CI/CD-driven proxy provisioning',
      'Trained client teams on API DX patterns — documentation, onboarding, JIRA workflows',
    ],
  },
  {
    sector: 'Drupal Specialist Consultancy',
    role: 'Drupal Architect & Principal Consultant',
    period: 'Jul 2015 – Dec 2018',
    tenure: '3.5 years',
    domains: ['Drupal Core', 'Open Source', 'Training', 'Architecture'],
    summary: 'Lead architect, consultant, trainer, and open-source contributor. Achieved recognition as a Top-30 global Drupal contributor. Authored 15+ contributed modules, spoke at DrupalCon and community events, and mentored teams across India and the UK.',
    highlights: [
      'Top-30 global Drupal contributor — 15+ published modules',
      'Conference speaker: DrupalCon and regional camps',
      'Delivered enterprise Drupal architecture for clients across e-commerce, education, and media',
    ],
  },
  {
    sector: 'Agency & Product Studios — UK & India',
    role: 'Developer → Lead Developer → Architect',
    period: 'Nov 2008 – Jun 2015',
    tenure: '7 years',
    domains: ['Drupal', 'PHP', 'Team Leadership'],
    summary: 'Progressive career across UK and Indian digital agencies — from Software Programmer through to Lead Developer and Solution Architect. Built expertise in Drupal, PHP, and technical team leadership across web, e-commerce, and digital transformation projects.',
    highlights: [
      '7-year progression from junior developer to solution architect across 5 organisations',
      'Built and led cross-functional engineering teams of up to 12 developers',
    ],
  },
]
